...
export const fetchToken = async (chainId, { contract, tokenId }) => {
  ...
  switch (`${attributesMap["ESSENCE"]}-${attributesMap["STATE"]}`) {
    case "BLACKOUT-FORGED": {
      ...
      mediaUrl =
        "https://openseauserdata.com/files/636617a79e713bd665d267828025bc21.mp4";
      break;
    }
    ...
    case "ICE-FORGED": {
      ...
      mediaUrl =
        "https://openseauserdata.com/files/f97ef45fb79ea6cb1acb3734fa56f635.mp4";
      break;
    }
    ...
    case "SPACE MATTER-FORGED": {
      ...
      mediaUrl =
        "https://openseauserdata.com/files/e3ea6181e301e6cee689b40229d4df68.mp4";
      break;
    }
    ...
    case "STONE-FORGED": {
      ...
      mediaUrl =
        "https://openseauserdata.com/files/ff4aa5e2e1bcc5d6087829807a09c2d4.mp4";
      break;
    }
