    ...
    .then((data) => {
      ...
      if (data.manas && data.manas.length > 0) {
        ...
        let meta = {
          ...
          description:
            "This item is Genesis Mana used in Loot (for Adventurers)",
        ...
        meta.attributes.push({
          category: "Properties",
          key: `Item Name`, //'item name' vs 'item' which is prefered?
        ...
        meta.attributes.push({
          category: "Properties",
          key: `Class`,
          value: data.manas[0].itemClass,
        });
        meta.attributes.push({
          category: "Properties",
          key: `Level`,
          value: data.manas[0].itemLevel,
        });
        meta.attributes.push({
          category: "Properties",
          key: `Greatness`,
          value: data.manas[0].itemGreatness,
        });
        /*
        Following code was used to determine loot bag id and greatness value. Loot bag id not required but greatness is. Pulling greatness data from API call instead
        of the following code, though unsure which method is prefered
        */
        ...
        //   });
        //   const rand = random(
        //     itemType.split(" ")[0].toUpperCase() + data.manas[0].lootTokenId.id
        //   );
