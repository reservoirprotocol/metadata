  ...
  return axios.get(url).then((response) => {
    if(response.data) {
      ...
      let meta = {
        ...
        "description": null, 
        "image": "https://bafybeidvwhrv57u6l5qmno5b6n4yd3gg44zjgrehsej527ciuxqbyulvvi.ipfs.infura-ipfs.io/",
        ...
        "collection": {
            ...
            "image": "https://lh3.googleusercontent.com/7nV2lPNF1qYpeTGIh1K-yBX9ezG9ziX45pUHM_fhnNlGj_htRXILODtNHSbp0prFixct4ndPSugqI5D_gMxFYtSd_1BsIrKxBNRcjw",
            "royaltyBps": "666",
